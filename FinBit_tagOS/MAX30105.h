...
/* TRY COMMENTING THESE OUT - THEY'RE ALL DEFINED IN BOARD.H INCLUDED IN THE PROJECT */

//#define Board_MPU9250_ADDR          (0x68)                  // Sparkfun MPU-9250 Breakout  - 9-DOF Accel + Mag + Gyro IMU Sensor Package
//#define Board_MPL3115A2_ADDR        (0x6O)                  // Sparkfun MPL3115A2 Breakout - Altitude and Temperature (??) Sensor Package
...
class MAX30105 {
    ...
    public:
        ...
        bool safeCheck(I2C_Handle i2c, uint8_t maxTimeToCheck); //Given a max amount of time, check for new data
        ...
        void readFIFODATA(I2C_Handle i2c, uint8_t regAddr, uint8_t numBytesToRead);
